...
wire hit_right_paddle = noob_switch ? ((h + R < 616)
                     && (h_next + R >= 616)
                     && (k_next >= c - (speed_y * 3)) && (k_next <= d + (speed_y * 3))) :
                     ((h + R < 616)
                     && (h_next + R >= 616)
                     && (k_next >= c - (speed_y * 4)) && (k_next <= d + (speed_y * 4)))
                     ;
                     
wire hit_left_paddle  = noob_switch ? ((h - R > 23)
                     && (h_next - R <= 23)
                     && (k_next >= a - (speed_y * 3)) && (k_next <= b + (speed_y * 3))) : 
                     ((h - R > 23)
                     && (h_next - R <= 23)
                     && (k_next >= a - (speed_y * 4)) && (k_next <= b + (speed_y * 4)))
                     ;
