...
output [7:0] an
    ...
    parameter IDLE=2'b00, PLAY=2'b01, MISS=2'b10; //finite states
...
wire hit_right_paddle = (h + R < 616)
                     && (h_next + R >= 616)
                     && (k_next >= c - speed_y) && (k_next <= d + speed_y);
                     
wire hit_left_paddle  = (h - R > 23)
                     && (h_next - R <= 23)
                     && (k_next >= a - speed_y) && (k_next <= b + speed_y);
                ...
                PLAY: begin
                   ...
                   if (hit_right_paddle) 
                    begin
                        ...
                        // c = top, d = bottom, total = 70px
                        if      (k >= c        && k < c + 17'sd14)  begin speed_x <= 17'sd6; speed_y <= 17'sd6; end  // zone 1 top
                        else if (k >= c+17'sd14 && k < c + 17'sd28) begin speed_x <= 17'sd4; speed_y <= 17'sd4; end  // zone 2
                        else if (k >= c+17'sd28 && k < c + 17'sd42) begin speed_x <= 17'sd2; speed_y <= 17'sd2; end  // zone 3 middle
                        else if (k >= c+17'sd42 && k < c + 17'sd56) begin speed_x <= 17'sd4; speed_y <= 17'sd4; end  // zone 4
                        else                                        begin speed_x <= 17'sd6; speed_y <= 17'sd6; end  // zone 5 bottom
                    end
                    ...
                    begin
                        ...
                        // a = top, b = bottom, total = 70px
                        if      (k >= a        && k < a + 17'sd14)  begin speed_x <= 17'sd6; speed_y <= 17'sd6; end  // zone 1 top
                        else if (k >= a+17'sd14 && k < a + 17'sd28) begin speed_x <= 17'sd4; speed_y <= 17'sd4; end  // zone 2
                        else if (k >= a+17'sd28 && k < a + 17'sd42) begin speed_x <= 17'sd2; speed_y <= 17'sd2; end  // zone 3 middle
                        else if (k >= a+17'sd42 && k < a + 17'sd56) begin speed_x <= 17'sd4; speed_y <= 17'sd4; end  // zone 4
                        else                                        begin speed_x <= 17'sd6; speed_y <= 17'sd6; end  // zone 5 bottom
                   end
