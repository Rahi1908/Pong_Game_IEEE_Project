...
module pong_game_8 (             //Working game         
input clk,
input rst,
    ...
    begin
       /* if ( z <= 35'sd100 )
        ...
        // --- PLAYER 1 SCORE (X: 259-284, Y: 24-48) ---
            if (h_count >= 259 && h_count <= 306 && v_count >= 16 && v_count <= 95) begin
                 case(p1_score)
                     2'd0: begin //  "0"
                            if ( ((v_count >= 16 && v_count <= 31) && (h_count >= 259 && h_count <= 306)) ||
                                ((v_count >= 32 && v_count <= 79) && ((h_count >= 259 && h_count <= 274) || (h_count >= 291 && h_count <= 306))) ||
                                ((v_count >= 80 && v_count <= 95) && (h_count >= 259 && h_count <= 306))
                                ) 
                            {red, grn, blue} = 12'hFFF; 
                            end
        
                    2'd1: begin // "1"
                         if ( ((v_count >= 16 && v_count <= 95) && (h_count >= 275 && h_count <= 290))
                   ...
                   2'd2: begin //  "2"
                        if ( ((v_count >= 16 && v_count <= 31) && (h_count >= 259 && h_count <= 306)) ||
                            ((v_count >= 32 && v_count <= 47) && (h_count >= 291 && h_count <= 306)) ||
                            ((v_count >= 48 && v_count <= 63) && (h_count >= 259 && h_count <= 306)) ||
                            ((v_count >= 64 && v_count <= 79) && (h_count >= 259 && h_count <= 274)) ||
                            ((v_count >= 80 && v_count <= 95) && (h_count >= 259 && h_count <= 306))
                            )
                            {red, grn, blue} = 12'hFFF;
                         end
                 ...
                 2'd3: begin //  "3"
                        if ( ((v_count >= 16 && v_count <= 31) && (h_count >= 259 && h_count <= 306)) ||
                            ((v_count >= 32 && v_count <= 47) && (h_count >= 291 && h_count <= 306)) ||
                            ((v_count >= 48 && v_count <= 63) && (h_count >= 259 && h_count <= 306)) ||
                            ((v_count >= 64 && v_count <= 79) && (h_count >= 291 && h_count <= 306)) ||
                            ((v_count >= 80 && v_count <= 95) && (h_count >= 259 && h_count <= 306))
                            )
                            {red, grn, blue} = 12'hFFF;
                        end
...
if (h_count >= 334 && h_count <= 381 && v_count >= 16 && v_count <= 95) begin
    case(p2_score)
        2'd0: begin //  "0"
            if ( ((v_count >= 16 && v_count <= 31) && (h_count >= 334 && h_count <= 381)) ||
                 ((v_count >= 32 && v_count <= 79) && ((h_count >= 334 && h_count <= 349) || (h_count >= 366 && h_count <= 381))) ||
                 ((v_count >= 80 && v_count <= 95) && (h_count >= 334 && h_count <= 381))
                ) 
                {red, grn, blue} = 12'hFFF; // Teal color from your image
        end
        
         2'd1: begin // "1"
            if ( ((v_count >= 16 && v_count <= 95) && (h_count >= 350 && h_count <= 365))
        ...
        2'd2: begin //  "2"
            if ( ((v_count >= 16 && v_count <= 31) && (h_count >= 334 && h_count <= 381)) ||
                 ((v_count >= 32 && v_count <= 47) && (h_count >= 366 && h_count <= 381)) ||
                 ((v_count >= 48 && v_count <= 63) && (h_count >= 334 && h_count <= 381)) ||
                 ((v_count >= 64 && v_count <= 79) && (h_count >= 334 && h_count <= 349)) ||
                 ((v_count >= 80 && v_count <= 95) && (h_count >= 334 && h_count <= 381))
                )
                {red, grn, blue} = 12'hFFF;
        end
        ...
        2'd3: begin //  "3"
            if ( ((v_count >= 16 && v_count <= 31) && (h_count >= 334 && h_count <= 381)) ||
                 ((v_count >= 32 && v_count <= 47) && (h_count >= 366 && h_count <= 381)) ||
                 ((v_count >= 48 && v_count <= 63) && (h_count >= 334 && h_count <= 381)) ||
                 ((v_count >= 64 && v_count <= 79) && (h_count >= 366 && h_count <= 381)) ||
                 ((v_count >= 80 && v_count <= 95) && (h_count >= 334 && h_count <= 381))
                )
                {red, grn, blue} = 12'hFFF;
        end
...
// ── parameters ────────────────────────────────────────────────
parameter PADDLE_SPEED = 17'sd6;

// ── manual velocity wires ─────────────────────────────────────
wire signed [16:0] lm_vel_manual = (lu && !ld) ? -PADDLE_SPEED :
                                   (ld && !lu) ?  PADDLE_SPEED : 17'sd0;

wire signed [16:0] rm_vel_manual = (ru && !rd) ? -PADDLE_SPEED :
                                   (rd && !ru) ?  PADDLE_SPEED : 17'sd0;
...
always @(*) begin
    ...
    if (!game_start && game_active) begin
        case(curr_state)
            ...
            DELAY:   nxt_state = (delay_cnt_pause >= 8'd180) ? IDLE : DELAY;
            ...
            case(curr_state)
                ...
                PLAY: begin
                   ...
                   if (hit_right_paddle) 
                    begin
                        dx <= -dx;
                        // 5 zones of right paddle, each 14px
                        if      (k >= c        && k < c + (d-c)/5)  begin speed_x <= 17'sd8; speed_y <= 17'sd8; end  // zone 1 top
                        else if (k >= c+(d-c)/5   && k < c + 2*(d-c)/5) begin speed_x <= 17'sd6; speed_y <= 17'sd6; end  // zone 2
                        else if (k >= c+2*(d-c)/5 && k < c + 3*(d-c)/5) begin speed_x <= 17'sd5; speed_y <= 17'sd5; end  // zone 3 middle
                        else if (k >= c+3*(d-c)/5 && k < c + 4*(d-c)/5) begin speed_x <= 17'sd6; speed_y <= 17'sd6; end  // zone 4
                        else                                        begin speed_x <= 17'sd8; speed_y <= 17'sd8; end  // zone 5 bottom
                    end

                  else if (hit_left_paddle) 
                    begin
                        dx <= -dx;
                        // same 5 zones for left paddle 
                        if      (k >= a           && k < a + (b-a)/5)  begin speed_x <= 17'sd8; speed_y <= 17'sd8; end  // zone 1 top
                        else if (k >= a+(b-a)/5   && k < a + 2*(b-a)/5) begin speed_x <= 17'sd6; speed_y <= 17'sd6; end  // zone 2
                        else if (k >= a+2*(b-a)/5 && k < a + 3*(b-a)/5) begin speed_x <= 17'sd5; speed_y <= 17'sd5; end  // zone 3 middle
                        else if (k >= a+3*(b-a)/5 && k < a + 4*(b-a)/5) begin speed_x <= 17'sd6; speed_y <= 17'sd6; end  // zone 4
                        else                                            begin speed_x <= 17'sd8; speed_y <= 17'sd8; end  // zone 5 bottom
                   end
